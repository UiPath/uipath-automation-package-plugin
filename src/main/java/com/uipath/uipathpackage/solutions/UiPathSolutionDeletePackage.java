...
import com.uipath.uipathpackage.models.solutions.SolutionDeletePackageOptions;
...
public class UiPathSolutionDeletePackage extends Recorder implements SimpleBuildStep {
    ...
    public UiPathSolutionDeletePackage(String packageName,
    ...
    public void perform(Run<?, ?> run, FilePath workspace, EnvVars env, Launcher launcher, TaskListener listener)
        ...
        if (tempRemoteDir == null) {
            throw new AbortException("Failed to create temp folder for solution delete.");
        }
        ...
        try {
            ...
            SolutionDeletePackageOptions options = new SolutionDeletePackageOptions();
            ...
            if (exitCode != 0) {
                throw new AbortException("UiPath CLI solution delete-package failed with exit code: " + exitCode);
            }
            logger.println("Delete package completed successfully.");
    ...
    @Symbol("UiPathSolutionDeletePackage")
    @Extension
    public static final class DescriptorImpl extends BuildStepDescriptor<Publisher> {
        ...
        public String getDisplayName() {
            return "UiPath Solution: Delete Package";
        }
